...
(function (window, document) {
  ...
  function validateScene(scene) {
    const supportedTypes = new Set(['point', 'midpoint', 'segment', 'line', 'circle', 'ellipse', 'polygon', 'measure', 'text']);
...
.geo2d-check {
  ...
  function toolUsesAnchorPreview(tool) {
    return ['point', 'segment', 'line', 'circle', 'ellipse', 'polygon', 'midpoint', 'measure-distance', 'text'].includes(tool);
  }
