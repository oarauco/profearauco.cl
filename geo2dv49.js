  ...
  class Geo2DEditor {
    ...
    refreshProperties() {
      ...
      if (!state.obj) {
        ...
        if (this.propAreaWrapEl) this.propAreaWrapEl.style.setProperty('display', 'none', 'important');
      ...
      if (this.propAreaWrapEl) this.propAreaWrapEl.style.setProperty('display', state.isPolygon ? 'flex' : 'none', 'important');
