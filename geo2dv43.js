...
(function (window, document) {
  ...
  function describeEllipseRefs(raw) {
    return `Centro ${raw.center || '—'}, rx ${formatNumberShort(raw.rx) || '—'}, ry ${formatNumberShort(raw.ry) || '—'}`;
  }
  ...
  function describeAreaRefs(raw) {
    return `Área de poligonal: ${joinObjectIds(Array.isArray(raw.points) ? raw.points : [])}`;
  }
