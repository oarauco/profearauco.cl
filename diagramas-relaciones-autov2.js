(function (window, document) {
  ...
  function asegurarCanvas(contenedor, width, height) {
    ...
    canvas.__oaLogicalWidth = width;
    canvas.__oaLogicalHeight = height;
    canvas.__oaDpr = dpr;
  ...
  function inicializarContenedor(contenedor, api) {
    ...
    if (contenedor.getAttribute("data-premium") === "true") config.premium = true;
    if (contenedor.getAttribute("data-theme")) config.theme = contenedor.getAttribute("data-theme");
    if (contenedor.getAttribute("data-title")) config.title = contenedor.getAttribute("data-title");
    if (contenedor.getAttribute("data-subtitle")) config.subtitle = contenedor.getAttribute("data-subtitle");
