...
gPoints.appendChild(createSvgEl('circle', {
  ...
  class Geo2DEditor {
    ...
    buildLayout() {
        ...
        this.root.innerHTML = `
          ...
          <div class="geo2d-body">
            <aside class="geo2d-side">
              <div class="geo2d-pane-head"><strong>Herramientas</strong></div>
              <div class="geo2d-toolgrid">${buildEditorToolMenuHtml()}</div>
            </aside>
            ...
            <aside class="geo2d-right">
              <section class="geo2d-section">
                <div class="geo2d-section-head"><strong>Objetos</strong></div>
                <div class="geo2d-section-content geo2d-object-list"></div>
              </section>
              <section class="geo2d-section">
                <div class="geo2d-section-head"><strong>Propiedades</strong></div>
                <div class="geo2d-section-content">
                  <label>Texto/etiqueta <input class="geo2d-prop-label" type="text"></label>
                  <label><input class="geo2d-prop-visible" type="checkbox"> Visible</label>
                  <label class="geo2d-prop-extra-wrap" style="display:none;">Unidad
          ...
          <div class="geo2d-modal" style="display:none;">
            <div class="geo2d-modal-card">
      ...
      this.modalBackdrop = this.root.querySelector('.geo2d-modal');
    ...
    refreshUI() {
      ...
      this.root.querySelectorAll('.geo2d-toolgroup').forEach(group => {
        ...
        if (items) items.style.display = isOpen ? 'grid' : 'none';
    ...
    refreshObjectList() {
      ...
      this.objectListEl.innerHTML = this.model.objects.map(obj => `
        <button class="geo2d-object-item${obj.id === this.selectedObjectId ? ' is-active' : ''}" data-object-id="${escapeHtml(obj.id)}">
          ${escapeHtml(obj.id)} <small>${escapeHtml(obj.raw.type || obj.raw.kind || '')}</small>
        </button>
      `).join('');
    }
    ...
    refreshProperties() {
      ...
      this.propLabelEl.disabled = !obj;
      this.propVisibleEl.disabled = !obj;
      if (!obj) {
      ...
      if (this.propExtraWrapEl && this.propExtraSelectEl) {
        ...
        this.propExtraWrapEl.style.display = isAngle ? 'flex' : 'none';
        if (isAngle) this.propExtraSelectEl.value = obj.raw.unit === 'rad' ? 'rad' : 'deg';
      }
    }
