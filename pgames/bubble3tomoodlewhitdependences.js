...
const ID_KATEX_CSS_BUBBLE = "bubble-profearauco-katex-css";

function cargarKatexParaBubble() {
  if (!document.getElementById(ID_KATEX_CSS_BUBBLE)) {
    const link = document.createElement("link");
    link.id = ID_KATEX_CSS_BUBBLE;
    link.rel = "stylesheet";
    link.href = "https://cdn.jsdelivr.net/gh/oarauco/profearauco.cl/dependencias/katex.min.css";
  ...
  return import("https://cdn.jsdelivr.net/gh/oarauco/profearauco.cl/dependencias/katex.mjs")
    .then(function (modulo) {
      window.katex = modulo.default || modulo;
      return window.katex;
    })
    .catch(function (error) {
      console.warn("Bubble Profearauco: no se pudo cargar KaTeX. Se usara texto plano.", error);
      return null;
    });
}
...
function inicializarBubbleProfearauco2() {
  document.querySelectorAll(".juegosprofearauco-bubble2-auto").forEach(function (root) {
    ...
    const datasetBox =
      root.querySelector(".juegosprofearauco-bubble2-dataset") ||
    ...
    try {
      ...
      root.innerHTML =
        "<p><strong>Error:</strong> El dataset del Bubble 2 no tiene formato JSON valido.</p>" +
...
window.inicializarBubbleProfearauco2 = inicializarBubbleProfearauco2;

function iniciarBubbleProfearauco2ConDependencias() {
  cargarKatexParaBubble().finally(function () {
    inicializarBubbleProfearauco2();
  });
}

window.inicializarBubbleProfearauco2 = inicializarBubbleProfearauco2;
window.iniciarBubbleProfearauco2ConDependencias = iniciarBubbleProfearauco2ConDependencias;

if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", iniciarBubbleProfearauco2ConDependencias);
} else {
  iniciarBubbleProfearauco2ConDependencias();
}
