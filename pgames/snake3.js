/* ============================================================
     SNAKE MATEMÁTICO v0.3 - CON AUDIO PROCEDURAL
...
(function () {
  ...
  class SintetizadorSnake {
    ...
    playAparicion() {
      this.tocarTono(600, 'sine', 0.05, 0.05); // Sonido sutil al aparecer items
    }

    playCorrecto(racha = 0) {
      const limiteRacha = Math.min(racha, 12);
      const tonoBase = 440 + (limiteRacha * 25); // Sube el pitch según la racha
    ...
    playChoque() {
      this.tocarTono(120, 'square', 0.2, 0.15); // Sonido corto y brusco
    }
