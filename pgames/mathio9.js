...
function drawHUD() {
    ...
    ctx.fillStyle = "white"; ctx.font = `bold ${compacto ? 13 : 17}px 'Segoe UI'`; ctx.textAlign = "right"; ctx.fillText(`Nivel ${nivelVisible} / ${niveles.length}`, canvas.width - 14, compacto ? 15 : 14);
}
