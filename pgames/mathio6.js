...
const MATHIO_CSS = `
        ...
        .mathio-juego .mathio-target-expression { font-size: clamp(15px, 2.3vw, 20px); background: rgba(0,0,0,0.72); padding: 5px 14px; border-radius: 12px; display: inline-block; font-weight: bold; box-shadow: 0 0 10px rgba(255,255,255,0.09); letter-spacing: 0; max-width: 100%; line-height: 1.15; }
