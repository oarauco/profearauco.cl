...
.geo2d-prop-subtitle {
  ...
  class Geo2DEditor {
    ...
    updateSelectedPolygonAreaVisibility(value) {
      const obj = this.getSelectedObject();
      if (!obj || InternalObjectAdapter.type(obj) !== 'polygon' || this.selectedPart) return false;
    ...
    refreshProperties() {
      ...
      if (!state.obj) {
        ...
        if (this.propAreaWrapEl) this.propAreaWrapEl.style.display = 'none';
      ...
      if (this.propAreaWrapEl) this.propAreaWrapEl.style.display = state.isPolygon ? 'flex' : 'none';
