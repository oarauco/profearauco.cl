...
.geo2d-notable-visible {
  ...
  function publishHtml(sceneLike, options = {}) {
    ...
    return `<div class="${DomUtils.escapeHtml(className)}" id="${DomUtils.escapeHtml(id)}" data-geo2d-viewer data-viewer-mode="${mode}"><textarea data-geo2d-scene style="display:none;">${sceneText}</textarea></div>`;
  }
