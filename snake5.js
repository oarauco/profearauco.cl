  ...
  class JuegoSnakeMatematico {
    ...
    dibujar() {
      ...
      if (this.preguntaActual) {
        this.dibujarTextoMatematico(ctx, this.preguntaActual.enunciado, 40, 50, 38, "#ffffff", "left");
      }
    ...
    dibujarObjetosEnLeyenda(ctx) {
      ...
      this.escenaActual.objetos.forEach((objeto, indice) => {
        ...
        // Text
        this.dibujarTextoMatematico(ctx, objeto.opcion.texto, lx + 75, cy, 22, "#ffffff", "left");
      });
    }
