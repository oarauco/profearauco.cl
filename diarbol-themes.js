(function (window) {
  ...
  THEMES.premium = crearTema(THEMES.base, {
    width: 1280,
    height: 820,
    ...
    interaction: {
      ...
      activeLeafFill: '#ecfdf7',
      dimOpacity: 0.22
    }
  });

  THEMES.compacto = crearTema(THEMES.premium, {
    width: 1120,
    height: 720,
  ...
  ALIASES['caso'] = 'casos';
  ALIASES['dashboard'] = 'premium';
  ALIASES['premium-dashboard'] = 'premium';
  ALIASES['compact'] = 'compacto';
