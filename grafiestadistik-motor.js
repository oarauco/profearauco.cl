(function (window) {
  ...
  function crearSVGBase(anchoSVG, altoSVG) {
    return `
      <svg viewBox="0 0 ${anchoSVG} ${altoSVG}" style="width:${anchoSVG}px; height:${altoSVG}px;">
        <rect x="0" y="0" width="${anchoSVG}" height="${altoSVG}" fill="white" />
      `;
  }
  ...
  window.GrafiEstadistik = Object.assign(window.GrafiEstadistik || {}, api);
